...
export declare class Ciudad {
  readonly id: string;
  readonly nameciudad?: string | null;
  readonly createdAt?: string | null;
  readonly updatedAt?: string | null;
  constructor(init: ModelInit<Ciudad, CiudadMetaData>);
  static copyOf(source: Ciudad, mutator: (draft: MutableModel<Ciudad, CiudadMetaData>) => MutableModel<Ciudad, CiudadMetaData> | void): Ciudad;
}